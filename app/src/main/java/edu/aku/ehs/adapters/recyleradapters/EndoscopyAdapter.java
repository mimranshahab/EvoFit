...
import edu.aku.ehs.models.EndoscopyModel;
...
//        setViews(holder, activity.getResources().getColor(R.color.base_green), R.drawable.rounded_box_filled_base_green, R.drawable.a_endoscopy_green);
    ...
    private void setViews(ViewHolder holder, int color, int backgroundResource, int imageSource) {
        ...
        holder.imgTransparent.setImageResource(imageSource);
