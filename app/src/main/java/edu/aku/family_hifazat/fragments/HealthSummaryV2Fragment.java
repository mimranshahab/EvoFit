...
public class HealthSummaryV2Fragment extends BaseFragment implements OnItemClickListener {
    Unbinder unbinder;
    ...
    ArrayList<PatientHealthSummaryModel> arrPatientHealthSummaryModel;
    ...
    public static HealthSummaryV2Fragment newInstance() {
        ...
        HealthSummaryV2Fragment fragment = new HealthSummaryV2Fragment();
...
//        light = Typeface.createFromAsset(getResources().getAssets(), "fonts/Roboto-Light_D.ttf");
    ...
    protected int getFragmentLayout() {
        return R.layout.fragment_health_summary_v2;
    }
...
//    }
                ...
                .webServiceRequestAPIForArray(WebServiceConstants.METHOD_PATIENT_HEALTH_SUMMARY,
                        ...
                        new WebServices.IRequestArrayDataCallBack() {
                            ...
                            public void requestDataResponse(WebResponse<ArrayList<JsonObject>> webResponse) {
                                ...
                                arrPatientHealthSummaryModel = GsonFactory.getSimpleGson()
    ...
    private void setPatientHealthSummaryData() {
        for (PatientHealthSummaryModel patientHealthSummaryModel : arrPatientHealthSummaryModel) {
