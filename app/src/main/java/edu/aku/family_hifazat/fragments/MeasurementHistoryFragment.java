...
public class MeasurementHistoryFragment extends BaseFragment implements OnItemClickListener {
    ...
    MeasurmentHistoryAdapter adapter;
    ...
    public static MeasurementHistoryFragment newInstance(PatientHealthSummaryModel modelHEIGHT, PatientHealthSummaryModel modelWEIGHT) {

        Bundle args = new Bundle();

        MeasurementHistoryFragment fragment = new MeasurementHistoryFragment();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new MeasurmentHistoryAdapter(getBaseActivity(), arrData, this);
...
//        recyclerView.setLayoutAnimation(animation);
    ...
    private void setData() {
        if (modelHEIGHT != null && modelWEIGHT != null) {
            // Height
            if ((modelHEIGHT.getHealthindicatorlist() == null || modelHEIGHT.getHealthindicatorlist().isEmpty()) || (modelWEIGHT.getHealthindicatorlist() == null || modelWEIGHT.getHealthindicatorlist().isEmpty())) {
                emptyView.setVisibility(View.VISIBLE);
                emptyView.setText("No Record Found");
            } else {
                arrData.clear();
                for (int i = 0; i < modelHEIGHT.getHealthindicatorlist().size(); i++) {
                    arrData.add(new HealthSummaryHistoryModel(modelHEIGHT.getHealthindicatorlist().get(i), modelWEIGHT.getHealthindicatorlist().get(i)));
                }
