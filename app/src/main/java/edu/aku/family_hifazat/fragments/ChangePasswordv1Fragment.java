...
public class ChangePasswordv1Fragment extends BaseFragment {
    ...
    public static ChangePasswordv1Fragment newInstance(String cardNumber) {

        Bundle args = new Bundle();

        ChangePasswordv1Fragment fragment = new ChangePasswordv1Fragment();
