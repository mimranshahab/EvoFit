package edu.aku.akuh_health_first.libraries.fileloader;
...
import edu.aku.akuh_health_first.libraries.fileloader.builder.FileDeleteBuilder;
import edu.aku.akuh_health_first.libraries.fileloader.builder.FileLoaderBuilder;
import edu.aku.akuh_health_first.libraries.fileloader.builder.MultiFileDownloader;
import edu.aku.akuh_health_first.libraries.fileloader.listener.FileRequestListener;
import edu.aku.akuh_health_first.libraries.fileloader.network.FileDownloader;
import edu.aku.akuh_health_first.libraries.fileloader.pojo.DownloadResponse;
import edu.aku.akuh_health_first.libraries.fileloader.pojo.FileResponse;
import edu.aku.akuh_health_first.libraries.fileloader.request.FileDeleteRequest;
