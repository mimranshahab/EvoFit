...
public class TimelineFragmentV1 extends BaseFragment implements View.OnClickListener, OnItemClickListener {
...
//        timelineModel.setText(getString(R.string.generic));
    ...
    public static TimelineFragmentV1 newInstance() {

        Bundle args = new Bundle();

        TimelineFragmentV1 fragment = new TimelineFragmentV1();
