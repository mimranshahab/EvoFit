package edu.aku.akuh_health_first.adapters;
...
public class MedicationProfileTabPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public MedicationProfileTabPagerAdapter(android.support.v4.app.FragmentManager fm, boolean isFromTimeline, int patientVisitAdmissionID) {
        super(fm);
...
//        return ForgotPasswordFragment.newInstance();
        switch (position) {
            case 0:
                return CurrentMedicationFragment.newInstance(isFromTimeline, patientVisitAdmissionID);
            case 1:
                return PreviousMedicationFragment.newInstance(isFromTimeline, patientVisitAdmissionID);
            default:
                return CurrentMedicationFragment.newInstance(isFromTimeline, patientVisitAdmissionID);
        }
