...
/**
 */
public class TimelineAdapterV1 extends RecyclerView.Adapter<TimelineAdapterV1.ViewHolder> {
    ...
    public TimelineAdapterV1(Activity activity, ArrayList<TimelineModel> userList, OnItemClickListener onItemClickListener) {
