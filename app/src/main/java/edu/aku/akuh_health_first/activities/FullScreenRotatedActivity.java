...
import edu.aku.akuh_health_first.fragments.Graph_View;
import edu.aku.akuh_health_first.fragments.HomeFragment;
import edu.aku.akuh_health_first.fragments.abstracts.BaseFragment;


public class FullScreenRotatedActivity extends BaseActivity {
...
//        setContentView(R.layout.activity_main);
    ...
    private void initFragments() {
        replacePermanentFramgment(Graph_View.newInstance());
    }
